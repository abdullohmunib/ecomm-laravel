                        ...
                        <div class="row items-grid">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_1.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_1.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_2.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_2.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                                        <div class="hover-2">
                                            <div class="product-actions">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_4.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_5.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_6.jpg') }}"
                                                alt="">
                                    ...
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_7.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_7.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                                        <div class="hover-2">
                                            <div class="product-actions">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_8.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_8.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                                        <div class="hover-2">
                                            <div class="product-actions">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_9.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_9.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                                        <div class="hover-2">
                                            <div class="product-actions">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_10.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_10.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                                        <div class="hover-2">
                                            <div class="product-actions">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_11.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-md-4 col-xs-6 product product-grid">
                                <div class="product-item clearfix">
                                    <div class="product-img hover-trigger">
                                        <a href="/product/1">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_12.jpg') }}"
                                                alt="">
                                            <img src="{{ asset('assets/frontend/img/shop/shop_item_back_12.jpg') }}"
                                                alt="" class="back-img">
                                        </a>
                                        <div class="product-label">
                                            <span class="sale">sale</span>
