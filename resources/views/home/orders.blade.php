...
@section('content')
    ...
    <section class="hero-wrap text-center relative">
        <div id="owl-hero" class="owl-carousel owl-theme light-arrows slider-animated">
            <div class="hero-slide overlay" style="background-image:url({{ asset('assets/frontend/img/hero/1.jpg') }})">
                <div class="container">
            ...
            <div class="hero-slide overlay" style="background-image:url({{ asset('assets/frontend/img/hero/2.jpg') }})">
                <div class="container">
                    <div class="hero-holder">
                        <div class="hero-message">
                            ...
                            <div class="buttons-holder">
                                <a href="#" class="btn btn-lg btn-color"><span>Buy it
                                        Now</span></a>
            ...
            <div class="hero-slide overlay" style="background-image:url({{ asset('assets/frontend/img/hero/3.jpg') }})">
                <div class="container">
                    <div class="hero-holder">
                        <div class="hero-message">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/img/shop/collection_1.jpg') }}" alt="">
                ...
                <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/img/shop/collection_2.jpg') }}" alt="">
                        <div class="overlay"></div>
                        <div class="promo-inner valign">
                            <h2>accessories</h2>
                ...
                <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/img/shop/collection_3.jpg') }}" alt="">
                        <div class="overlay"></div>
                        <div class="promo-inner valign">
                            <h2>for him</h2>
            ...
            <div class="row items-grid">
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="product-item hover-trigger">
                        <div class="product-img">
                            <a href="{{ asset('assets/frontend/shop-single.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_1.jpg') }}" alt="">
                            </a>
                            ...
                            <div class="hover-overlay">
                                ...
                                <div class="product-details valign">
                                    <span class="category">
                                        <a href="{{ asset('assets/frontend/catalogue-grid.html') }}">Women</a>
                                    </span>
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Drawstring
                                            Dress</a>
                                    </h3>
                                    <span class="price">
                                        <del>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="product-item hover-trigger">
                        <div class="product-img">
                            <a href="{{ asset('assets/frontend/shop-single.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_2.jpg') }}" alt="">
                            </a>
                            <div class="hover-overlay">
                                <div class="product-actions">
                                    <a href="#" class="product-add-to-wishlist">
                                ...
                                <div class="product-details valign">
                                    <span class="category">
                                        <a href="{{ asset('assets/frontend/catalogue-grid.html') }}">Accessories</a>
                                    </span>
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Mesh
                                            Sandal</a>
                                    </h3>
                                    <span class="price">
                                        <ins>
                        ...
                        <div class="product-img">
                            ...
                            <div class="hover-overlay">
                                ...
                                <div class="product-details valign">
                                    ...
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Tribal Grey
                                            Blazer</a>
                                    </h3>
                                    <span class="price">
                                        <ins>
                    ...
                    <div class="product-item hover-trigger">
                        <div class="product-img">
                            ...
                            <div class="hover-overlay">
                                ...
                                <div class="product-details valign">
                                    <span class="category">
                                        <a href="{{ asset('assets/frontend/catalogue-grid.html') }}">Men</a>
                                    </span>
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Sweater w/
                                            Colar</a>
                                    </h3>
                                    <span class="price">
                                        <ins>
                        ...
                        <div class="product-img">
                            ...
                            <div class="hover-overlay">
                                ...
                                <div class="product-details valign">
                                    ...
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Lola May
                                            Crop
                                            Blazer</a>
                                    </h3>
                                    <span class="price">
                        ...
                        <div class="product-img">
                            ...
                            <div class="hover-overlay">
                                ...
                                <div class="product-details valign">
                                    ...
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Faux
                                            Suits</a>
                                    </h3>
                                    <span class="price">
                                        <del>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="product-item hover-trigger">
                        <div class="product-img">
                            <a href="{{ asset('assets/frontend/shop-single.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_7.jpg') }}" alt="">
                            </a>
                            <div class="hover-overlay">
                                <div class="product-actions">
                                    <a href="#" class="product-add-to-wishlist">
                                ...
                                <div class="product-details valign">
                                    ...
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Crew
                                            Watch</a>
                                    </h3>
                                    <span class="price">
                                        <ins>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="product-item hover-trigger">
                        <div class="product-img">
                            <a href="{{ asset('assets/frontend/shop-single.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_8.jpg') }}" alt="">
                            </a>
                            <div class="hover-overlay">
                                <div class="product-actions">
                                    <a href="#" class="product-add-to-wishlist">
                                ...
                                <div class="product-details valign">
                                    ...
                                    <h3 class="product-title">
                                        <a href="{{ asset('assets/frontend/shop-single.html') }}">Jersey
                                            Stylish</a>
                                    </h3>
                                    <span class="price">
                                        <ins>
    ...
    <section class="section-wrap relative testimonials bg-parallax overlay"
        style="background-image:url({{ asset('assets/frontend/img/testimonials/testimonial_bg.jpg') }});">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 mb-40 products-widget">
                    ...
                    <ul class="product-list-widget">
                        <li class="clearfix">
                            <a href="{{ asset('assets/frontend/shop-single-product.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_1.jpg') }}" alt="">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 mb-40 products-widget">
                    ...
                    <ul class="product-list-widget">
                        <li class="clearfix">
                            <a href="{{ asset('assets/frontend/shop-single-product.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_9.jpg') }}" alt="">
                        ...
                        <li class="clearfix">
                            <a href="{{ asset('assets/frontend/shop-single-product.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_10.jpg') }}" alt="">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 products-widget last">
                    ...
                    <ul class="product-list-widget">
                        ...
                        <li class="clearfix">
                            <a href="{{ asset('assets/frontend/shop-single-product.html') }}">
                                <img src="{{ asset('assets/frontend/img/shop/shop_item_12.jpg') }}" alt="">
