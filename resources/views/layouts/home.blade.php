...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/sliders.css') }}" />
                        ...
                        <div class="row flex-parent">
                            ...
                            <div class="navbar-header flex-child">
                                ...
                                <div class="logo-container">
                                    <div class="logo-wrap">
                                        <a href="{{ asset('assets/frontend/index.html') }}">
                                            <img class="logo-dark2"
                                                src="{{ asset('assets/frontend/img/logo_dark2 - .png') }}"
                                                alt="logo">
                                        </a>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 megamenu-item">
                                                                <ul class="menu-list">
                                                                    ...
                                                                    <li><a href="/products/1">Catalog no Sidebar</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    <img src="{{ asset('assets/frontend/img/logo_dark.png') }}" alt=""
                                        class="logo">
